#!/usr/bin/env python3
"""Simple test script to verify MP3 processing works"""
import sys
import os

# Add clearvoice to the path the same way demo.py does it
sys.path.insert(0, os.path.join(os.path.dirname(__file__), 'clearvoice'))
